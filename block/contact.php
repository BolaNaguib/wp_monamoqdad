...
<section class="py-24">
    ...
    <div class='container mx-auto px-4 text-center'>
        <h3 class="mb-12">Contact us immediately</h3>
        <div class="grid grid-cols-3 gap-4 relative">
            <hr class="absolute w-4/6 ml-48 mt-8 border z-0">
            <?php for ($i = 0; $i < 3; $i++) : ?>
                <div class="text-center  relative z-10">
                    <div class="inline-block border p-6 bg-white">
                    ...
                    <b class="block my-4">Numbers</b>
                    <span class="block text-gray-600">01023989330</span>
                </div>
            <?php endfor; ?>
        </div>
        <div class="forminput my-32">
