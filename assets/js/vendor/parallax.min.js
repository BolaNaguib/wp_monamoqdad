!(function (t, i, e) {
	...
	function r(t, i) {
		...
		for (var o in e) null === e[o] && delete e[o];
		this.extend(this, a, i, e),
	...
	(r.prototype.extend = function () {
		...
		(r.prototype.transformSupport = function (o) {
			for (
				...
				if (
					(null !== this.vendors[c]
						? ((h = this.vendors[c][0] + "transform"),
						  (l = this.vendors[c][1] + "Transform"))
				...
				case "3D":
					if (a) {
						...
						i.body ||
							...
							(d.style.background = "")),
							d.appendChild(s),
							(s.style[l] = "translate3d(1px,1px,1px)"),
							(r = t.getComputedStyle(s).getPropertyValue(h)),
							(n = r !== e && r.length > 0 && "none" !== r),
							(u.style.overflow = f),
							d.removeChild(s),
							m && (d.removeAttribute("style"), d.parentNode.removeChild(d));
					}
			}
			return n;
		}),
		...
		(r.prototype.motionStatus = 0),
		(r.prototype.propertyCache = {}),
		(r.prototype.initialise = function () {
			r.prototype.transform2DSupport === e &&
		...
		(r.prototype.updateLayers = function () {
			...
			for (var t = 0, i = this.layers.length; i > t; t++) {
				...
				this.depthsX.push(this.data(e, "depth-x") || o),
					this.depthsY.push(this.data(e, "depth-y") || o);
			}
		}),
			...
			if (!s)
				for (var a = 0, r = this.vendors.length; r > a; a++)
					if (
						((s =
							null !== this.vendors[a]
								? this.camelCase(this.vendors[a][1] + "-" + i)
								: i),
						t.style[s] !== e)
					) {
		...
		(r.prototype.accelerate = function (t) {
			this.css(t, "transform", "translate3d(0,0,0) rotate(0.0001deg)"),
		...
		(r.prototype.rotate = function (t, i) {
			var e = (event.beta || 0) / s,
				o = (event.gamma || 0) / s,
				a = this.wh > this.ww;
			this.portrait !== a && ((this.portrait = a), (this.calibrationFlag = !0)),
				this.calibrationFlag &&
					((this.calibrationFlag = !1), (this.cx = e), (this.cy = o)),
				(this.ix = e),
				(this.iy = o);
		}),
